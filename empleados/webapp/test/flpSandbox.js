		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App empleados",
									"targetURL": "#logaliempleados-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaliempleados-display": {
								"semanticObject": "logaliempleados",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logali.empleados",
									"url": sap.ui.require.toUrl("logali/empleados")
								}
							}
						}
					}
