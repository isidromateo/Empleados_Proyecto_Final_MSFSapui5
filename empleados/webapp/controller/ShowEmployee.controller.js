sap.ui.define([
	...
	function onRiseEmployee(oEvent){
		if(!this.riseDialog){
            //this.riseDialog = sap.ui.xmlfragment("logaligroup/fragment/RiseEmployee", this);
			this.riseDialog = sap.ui.xmlfragment("logali/empleados/fragment/RiseEmployee", this);
	...
	return Controller.extend("logali.empleados.controller.ShowEmployee", {
		onInit: onInit,
