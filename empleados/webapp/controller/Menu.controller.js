sap.ui.define([
	...
	function onAfterRendering(){
		...
		let oDOM = genericTileFirmarPedido.getDomRef();
		console.log(genericTileFirmarPedido);

		//Inicializar el id como null
		$(oDOM)[0].id = "";
	...
	return Controller.extend("logali.empleados.controller.Menu", {
		onInit: onInit,
